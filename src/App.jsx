...
function App() {
  ...
  const hadleGraduationYearChange = event => setGraduationYear(event.target.value)
  const handleGraduatedChange = event => setGraduated(event.target.cheked)
        ...
        <div>
          ...
          <label>
            ...
            <input
              ...
              onChange={hadleGraduationYearChange}
              name="graduationYear"
              type="number"
